...
// import 'order_specification_screen.dart';
//
...
//   OrderSpecificationDTO? _specification;
//
...
//   }
//
//   void _openSpecification() async {
//     final result = await Navigator.push<OrderSpecificationDTO>(
//       context,
//       MaterialPageRoute(
//         builder: (context) => OrderSpecificationScreen(
//           onSpecificationComplete: (specification) {
//             Navigator.pop(context, specification);
//           },
//         ),
//       ),
//     );
...
//           specification: _specification, // Добавляем спецификацию
//         );
//
...
//               )),
//               const SizedBox(height: 24),
//               // ✅ КНОПКА ДЛЯ ЗАПОЛНЕНИЯ СПЕЦИФИКАЦИИ
//               Container(
//                 decoration: BoxDecoration(
...
//                   leading: Icon(
//                     Icons.assignment,
//                     color: _specification != null ? Colors.green : Theme.of(context).primaryColor,
//                   ),
//                   title: Text(
//                     _specification != null ? 'Детали заказа указаны' : 'Детали заказа',
//                     style: TextStyle(
//                       fontWeight: _specification != null ? FontWeight.bold : FontWeight.normal,
//                     ),
//                   ),
//                   subtitle: Text(
//                     _specification != null
//                         ? 'Нажмите для изменения'
//                         : 'Укажите площадь, тип уборки, дополнительные услуги',
