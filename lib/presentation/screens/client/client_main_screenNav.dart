...
import '../../providers/client_nav_provider.dart';
import 'home_screen.dart';
import 'my_orders_screen.dart';
import 'all_order_offers_screen.dart';
import '../common/my_profile_screen.dart';

class ClientMainScreen extends ConsumerStatefulWidget {
  final int initialTab;
  const ClientMainScreen({super.key, this.initialTab = 0});
...
class _ClientMainScreenState extends ConsumerState<ClientMainScreen>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ref.read(clientTabProvider.notifier).state = widget.initialTab;
    });
  }
  ...
  Widget build(BuildContext context) {
    final activeTab = ref.watch(clientTabProvider);
